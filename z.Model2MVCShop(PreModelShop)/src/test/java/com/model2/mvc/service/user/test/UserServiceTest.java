...
//			userService.addUser(user);
	 ...
	 public void testGetUserListAll() throws Exception{
		...
		//==> console 확인
	 	...
	 	System.out.println(userService.getUserList(search).get("list").toString());
	 	System.out.println(userService.getUserList(search).get("totalCount"));
	...
	// @Test
	 ...
	 @Test
	 public void testGetCartData() throws Exception {
		 userService.updateCart("10003", "user04");
		// userService.deleteCart("user01", "10006");
